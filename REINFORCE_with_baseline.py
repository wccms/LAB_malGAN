...
# -*- coding: utf-8 -*-
"""
Created on Thu Nov  2 15:32:01 2017
...
class PolicyEstimator():
    ...
    in malGAN: Policy is equal to Generator
    """
    ...
    def __init__(self, learning_rate=0.01, scope="policy_estimator"):
        ...
        with tf.variable_scope(scope):
            self.state = tf.placeholder(dtype=tf.int32, [self.state_dim], name="state")
...
def malGAN_env(blackboxD,dataset)
